...
const SearchedFilms = () => {
  ...
  const getFilmDetails = async (imdbID) => {
    ...
    // const testUrl = "http://www.omdbapi.com/?apikey=973b4444&i=tt0371746&plot=full";
    ...
    <div>
      {!searchClicked ? (
        <div className="initial-search">
          ...
          <h1 className="searchField">
            Search<span className="blue">Here</span>
          </h1>
          <input
            className="input"
            type="text"
          ...
          />
          <button className="btn-search" onClick={getFilm}>
            Search
          </button>
        </div>
      ) : null}
              ...
              {filmData.Search.map((film, index) => (
                <li key={index}>
                  {/* <div>
                    ...
                    <div>
                      <button
                        className="buyMovieBtn"
                        onClick={() => handleBuy(film)}
                      >
                        Buy
                      </button>
                      <button
